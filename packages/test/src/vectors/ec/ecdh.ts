import * as webcryptoTypes from "@peculiar/webcrypto-types";
import { Convert } from "pvtsutils";
import { ITestGenerateKeyAction, ITestParams } from "../../types";

export const ECDH: ITestParams = {
  name: "ECDH",
  actions: {
    generateKey: ["P-256", "P-384", "P-521", "K-256"].map((namedCurve) => {
      return {
        ...
        algorithm: {
          name: "ECDH",
          namedCurve,
        } as webcryptoTypes.EcKeyGenParams,
        extractable: false,
    ...
    import: [
      {
        ...
        algorithm: {
          name: "ECDH",
          namedCurve: "P-256",
        } as webcryptoTypes.EcKeyImportParams,
        extractable: true,
        keyUsages: ["verify"],
      },
      {
    ...
    deriveKey: [
      {
        ...
        derivedKeyType: {
          name: "AES-CBC",
          length: 128,
        } as webcryptoTypes.AesKeyAlgorithm,
