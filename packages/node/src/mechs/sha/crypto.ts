...
export class ShaCrypto {
   ...
   */
  public static size(algorithm: types.Algorithm) {
   ...
   * @throws Throws Error if an unrecognized name
   */
  public static getAlgorithmName(algorithm: types.Algorithm): string {
    switch (algorithm.name.toUpperCase()) {
      case "SHA-1":
        return "sha1";
      case "SHA-256":
  ...
  public static digest(algorithm: types.Algorithm, data: ArrayBuffer) {
